        ...
        <div class="max-w-7xl mx-auto px-4 py-14">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div class="md:col-span-1">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed">Premium dress rentals with Nepali calendar booking & digital payments. Look stunning at every event.</p>
            ...
            <!-- Bottom bar -->
                ...
                <p class="text-gray-500 text-sm">© {{ date('Y') }} DressRental Nepal. All rights reserved.</p>
