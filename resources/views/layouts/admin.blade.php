        ...
        <nav class="flex-1 py-4 overflow-y-auto px-2">
            @php
                $navItems = [
                    ...
                    ['route' => 'admin.banners.index',   'label' => 'Banners',    'icon' => 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', 'color' => 'text-orange-400'],
                    ...
                    ['route' => 'admin.ornaments.index', 'label' => 'Ornaments',  'icon' => 'M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7', 'color' => 'text-fuchsia-400'],
                    ['route' => 'admin.pages.index',    'label' => 'Pages',      'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', 'color' => 'text-teal-400'],
