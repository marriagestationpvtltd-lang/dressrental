...
<div class="max-w-lg">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.banners.update', $banner) }}" enctype="multipart/form-data"
              x-data="{ mediaType: '{{ old('media_type', $banner->media_type) }}' }">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                    ...
                    @if($banner->media_type === 'image')
                        <div class="mb-2">
                            <img src="{{ $banner->image_url }}" alt="{{ $banner->title }}"
                                 class="h-24 object-cover rounded-xl border border-gray-100">
                ...
                <div x-show="mediaType === 'youtube'">
                    ...
                    <input type="text" name="youtube_url"
                           value="{{ old('youtube_url', $banner->media_type === 'youtube' ? 'https://www.youtube.com/watch?v=' . $banner->media_value : '') }}"
